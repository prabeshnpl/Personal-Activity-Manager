...
from tasks.adapter.serializers.task_serializer import TaskSerializer
from tasks.data.db.task_impl import TaskRepositoryImpl
from tasks.domain.usecase.task_usecase import CreateTaskUseCase, DeleteTaskUseCase, GetTaskByIdUseCase, UpdateTaskUseCase, ListTasksUseCase
...
class TaskView(BaseTenantModelViewSet):
    ...
    def retrieve(self, request, pk:int):
        usecase = GetTaskByIdUseCase(repo=self.repository())
    ...
    def list(self, request, *args, **kwargs):
        usecase = ListTasksUseCase(repo=self.repository())
    ...
    def create(self, request, *args, **kwargs):
        usecase = CreateTaskUseCase(repo=self.repository())
        data = request.data
    ...
    def update(self, request, *args, **kwargs):
        ...
        usecase = UpdateTaskUseCase(repo=self.repository())
